...
BEGIN
    ...
    LEFT JOIN PacienteNutricionista pn ON pn.NutricionistaCodigo = n.CodigoNutricionista
    GROUP BY n.TipoCobro, n.Email, n.Nombre, n.Apellido1, n.Apellido2, n.NumeroTarjeta
    ORDER BY n.TipoCobro, NombreCompleto;
END;
GO
